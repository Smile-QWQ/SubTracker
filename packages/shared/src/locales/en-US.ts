export default {
  ...
  app: {
    ...
    viewRelease: 'View commit',
    noNewRelease: 'No newer lite commits than the current version.',
  ...
  login: {
    title: 'Sign in to SubTracker Lite',
  ...
  settings: {
    ...
    helps: {
      ...
      workerRuntime: 'Current runtime: Cloudflare Worker + D1',
      workerRuntimeR2Enabled: ', R2 enabled',
      workerRuntimeR2Disabled: ', R2 disabled; only remote logo references are supported',
